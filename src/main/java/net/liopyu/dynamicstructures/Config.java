...
public class Config {
    ...
    public static final ForgeConfigSpec.BooleanValue GENERATE_EXAMPLE_STRUCTURE = BUILDER
            .comment("Automatically generate an example structure JSON if none exist.")
            .define("generate_example_structure", true);
    public static final ForgeConfigSpec.ConfigValue<String> STRUCTURE_LOCATION = BUILDER
            .comment("File location for structure files.")
            .define("structure_directory", "config/dynamicstructures/structures/");
    public static final ForgeConfigSpec.BooleanValue GENERATE_EXAMPLE_STRUCTURE_SET = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> STRUCTURE_SET_LOCATION = BUILDER
            .comment("File location for structure_set files.")
            .define("structure_set_directory", "config/dynamicstructures/structure_set/");
    public static final ForgeConfigSpec ASPEC = BUILDER.build();
